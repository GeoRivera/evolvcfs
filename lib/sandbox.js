...
setTimeout(function () {
    ...
    $('#time_' + fieldName).change(function () {
        $$.dateIsAfter('actual_date', 'amended_dt_tm', 'Actual Date must be after Amended Date');
    });
}, 50);
...
var blah = [[d1, '<', d2, 'd1 < d2'], [d1, '=', d2, 'd1 = d2'], [d1, '<=', d2, 'd1 <= d2'], [d1, 'after', d2, 'd1 > d2']];
...
[['actual_date', '>=', 'udf_datetimearrivedined_TA', 'Actual Date must be after Date/Time Arrived in ED'], ['udf_datetimeofrequest_TA', '>=', 'udf_datetimearrivedined_TA', 'Date/Time of Request must be after Date/Time Arrived in ED'], ['udf_datetimeofreadiness_TA', '>=', 'udf_datetimearrivedined_TA', 'Date/Time Readiness must be after Date/Time Arrived in ED'], ['udf_datetimeinterventinbegan_TA', '>=', 'udf_datetimearrivedined_TA', 'Date/Time Intervention Began must be after Date/Time Arrived in ED'], ['udf_datetimeinterventionended_TA', '>=', 'udf_datetimearrivedined_TA', 'Date/Time Intervention Ended must be after Date/Time Arrived in ED'], ['udf_datetimebedsearchbegan_TA', '>=', 'udf_datetimearrivedined_TA', 'Date/Time Bed Search Began must be after Date/Time Arrived in ED'], ['udf_datetimeplacementsecured_TA', '>=', 'udf_datetimearrivedined_TA', 'Date/Time Placement Secured must be after Date/Time Arrived in ED'], ['udf_datetimecallplacedforconsult_TA', '>=', 'udf_datetimearrivedined_TA', 'Date/Time Call Placed for Consult must be after Date/Time Arrived in ED'], ['udf_datetimesonsultbegan_TA', '>=', 'udf_datetimearrivedined_TA', 'Date/Time Consult Began must be after Date/Time Arrived in ED'], ['udf_dateforemrgencypschopharm_TA', '>=', 'udf_datetimearrivedined_TA', 'Date/Time Called for Emergency Psychopharm must be after Date/Time Arrived in ED']];

setTimeout(function () {
    var fieldName = 'udf_datetimearrivedined_TA';
    $('#time_' + fieldName).change(function () {
        $$.allDt([['actual_date', '>=', 'udf_datetimearrivedined_TA', 'Actual Date must be after Date/Time Arrived in ED'], ['udf_datetimeofrequest_TA', '>=', 'udf_datetimearrivedined_TA', 'Date/Time of Request must be after Date/Time Arrived in ED'], ['udf_datetimeofreadiness_TA', '>=', 'udf_datetimearrivedined_TA', 'Date/Time Readiness must be after Date/Time Arrived in ED'], ['udf_datetimeinterventinbegan_TA', '>=', 'udf_datetimearrivedined_TA', 'Date/Time Intervention Began must be after Date/Time Arrived in ED'], ['udf_datetimeinterventionended_TA', '>=', 'udf_datetimearrivedined_TA', 'Date/Time Intervention Ended must be after Date/Time Arrived in ED'], ['udf_datetimebedsearchbegan_TA', '>=', 'udf_datetimearrivedined_TA', 'Date/Time Bed Search Began must be after Date/Time Arrived in ED'], ['udf_datetimeplacementsecured_TA', '>=', 'udf_datetimearrivedined_TA', 'Date/Time Placement Secured must be after Date/Time Arrived in ED'], ['udf_datetimecallplacedforconsult_TA', '>=', 'udf_datetimearrivedined_TA', 'Date/Time Call Placed for Consult must be after Date/Time Arrived in ED'], ['udf_datetimesonsultbegan_TA', '>=', 'udf_datetimearrivedined_TA', 'Date/Time Consult Began must be after Date/Time Arrived in ED'], ['udf_dateforemrgencypschopharm_TA', '>=', 'udf_datetimearrivedined_TA', 'Date/Time Called for Emergency Psychopharm must be after Date/Time Arrived in ED']]);
    });
}, 50);
